...
namespace Dyd.BaseService.Monitor.Domain.TimeWatch.Dal
{
	...
	public partial class tb_timewatchlog_api_dayreport_dal
    {
        ...
        public virtual bool Delete(DbConn PubConn, int id)
        {
            ...
            string Sql = "delete from tb_timewatchlog_api_dayreport where id=@id";
        ...
        public virtual tb_timewatchlog_api_dayreport_model Get(DbConn PubConn, int id)
        {
            List<ProcedureParameter> Par = new List<ProcedureParameter>();
            Par.Add(new ProcedureParameter("@id", id));
            StringBuilder stringSql = new StringBuilder();
            stringSql.Append(@"select s.* from tb_timewatchlog_api_dayreport s where s.id=@id");
