...
{
    public class SqlHashContrastUrlCollectTask : XXF.BaseService.TaskManager.BaseDllTask
    {
        public override void Run()
        {
            ...
            {
                base.OpenOperator.Error("统计SQLHASH和URL的对照信息失败", exception);
            }
        }
        ...
        private void Do()
        {
            ...
            bool c = Dal.GenerationTask();
            if (c)
            {
                base.OpenOperator.Log("统计SQLHASH和URL的对照信息成功");
            }
        }
